 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://ws.accenture.it/", wsdlLocation = "http://localhost:8080/web-service/WebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICE_QNAME = new QName("http://ws.accenture.it/", "WebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/web-service/WebService?wsdl");
    ...
    public WebServiceManager getWebServiceManagerPort() {
        return super.getPort(new QName("http://ws.accenture.it/", "WebServiceManagerPort"), WebServiceManager.class);
    }
    ...
    public WebServiceManager getWebServiceManagerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.accenture.it/", "WebServiceManagerPort"), WebServiceManager.class, features);
    }
